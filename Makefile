D_SRC			=	builtin/builtin.c builtin/run_commands.c builtin/run_echo.c builtin/export.c\
				...
				parser/env_process.c parser/lexer.c lib/utiels.c parser/parser.c parser/quotes.c parser/dollar.c parser/heredoc_sep.c parser/double_sep.c parser/single_sep.c parser/extra.c\
